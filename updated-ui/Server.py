...
def admin():
    ...
    return render_template('Admin.html', surveys=surveys, average_ratings=average_ratings, overall_srating=overall_srating, unknown_questions=unique_unknown_questions)
